...
def select_role(role):
    ...
    if role == "팀플 지옥":
        ...
        st.session_state["messages"].append({"role": "user", "content": "또 내가 너 이름을 프로젝트에서 빼버리겠다고 말하면 니가 뭔 권리로 내 이름을 빼냐는 것처럼 화내면서 말해줘. 그리고 마지막으로 항상 명심해 존댓말 하지마. 약간 팀에 기생충마냥 빌붙어먹으려는 행동을 보여줘 "})
